# EquGuess
a race game (made with HTML, CSS and JavaScript) to play with up to 4 friends or in solo mode if you prefer it that way, the idea is simple, do the math before the rest and win, your time for each equation will be counted and you can see your stats in the end!
